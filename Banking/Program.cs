...
namespace tests
{
    class Program
    {
        ...
        {
            Console.WriteLine("Welcome to sample ATM example built on c#");
        ...
        private static void CreateAccount(List<Records> records)
        {
            ...
            records.Add(new Records() { AccountId = accountId, User = user, Password = password, Balance = 1000.0m });
                            ...
                            switch (input)
                            {
                                ...
                                case "3":
                                    ...
                                    if (decimal.TryParse(input, out var withdraw))
                                    {
                                        ...
                                        {
                                            Console.WriteLine("Error: Balance cannot be below 50.");
                                        }
                                ...
                                case "5":
                                    atmModeShouldClose = true;
                                    systemShutdown = true;
                                    Console.WriteLine("Thank for Banking with us. Goodbye.");
                                    break;
                            }
                        }
                    }
